...
namespace FurnitureCityBE.Models
{
  public class FurnitureStoreDb : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      var livingRoomCategoryId = new Category { Id = new Guid("e06629eb-de6b-41e1-b4e9-01d6bac0a3c0"), Name = "Living Room" };
      var bedroomCategoryId = new Category { Id = new Guid("94d4fdb7-b1b7-4b42-aea4-08dc058baf26"), Name = "Bedroom" };
      ...
      modelBuilder.Entity<ProductTag>().HasData(
        new ProductTag { Id = Guid.NewGuid(), Name = "Modern" },
        new ProductTag { Id = Guid.NewGuid(), Name = "Luxury" },
        new ProductTag { Id = Guid.NewGuid(), Name = "Ergonomic" }
      );
